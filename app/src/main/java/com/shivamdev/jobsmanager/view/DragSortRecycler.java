package com.shivamdev.jobsmanager.view;
...
public class DragSortRecycler extends RecyclerView.ItemDecoration
    ...
    private static final String TAG = DragSortRecycler.class.getSimpleName();
    ...
    private int getNewPostion(RecyclerView rv) {
        ...
        //Scan though items on screen, however they may not be in order!
